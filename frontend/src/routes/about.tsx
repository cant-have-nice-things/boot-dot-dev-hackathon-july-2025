        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
          <div className="bg-card p-6 rounded-lg border">
            ...
            <p className="text-muted-foreground leading-relaxed">
              HackApp is a production-ready React template built with modern tools and best
              practices. It provides a solid foundation for building web applications with
              TypeScript, TanStack Router, Tailwind CSS, and shadcn/ui components.
            </p>
          </div>
          ...
          <div className="bg-card p-6 rounded-lg border">
            ...
            <p className="text-muted-foreground mb-4">
              This template is designed to be easily customizable. Simply update the content, add
              your routes, and start building your application.
            </p>
